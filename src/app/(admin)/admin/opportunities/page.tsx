...
export default function AdminOpportunitiesPage() {
  ...
  async function saveEdit(id: string | number) {
    ...
    setSubmissions((current) => current.map((item) => item.id === id ? { ...item, title: editForm.title, short_description: editForm.short_description, description: editForm.description, direct_url: editForm.direct_url, earnings_text: editForm.earnings_text, category_id: editForm.category_id, countries: textToList(editForm.countries), devices: textToList(editForm.devices), payment_methods: textToList(editForm.payment_methods), requirements: textToList(editForm.requirements) } : item));
    setEditingId(null);
  }
