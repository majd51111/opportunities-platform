...
const categoryTranslations: Record<string, Record<LanguageCode, string>> = {
  ...
  "أبحاث ودراسات": {
    ar: "أبحاث ودراسات",
    en: "Research and studies",
    es: "Investigación y estudios",
    fr: "Recherche et études",
    de: "Forschung und Studien",
    pt: "Pesquisa e estudos",
    ja: "研究と調査",
    zh: "研究与调查",
  },
  ...
  "Surveys & Research": {
    ar: "الاستبيانات والدراسات",
    en: "Surveys & Research",
    es: "Encuestas e investigación",
    fr: "Sondages et recherche",
    de: "Umfragen und Forschung",
    pt: "Pesquisas e estudos",
    ja: "アンケートと研究",
    zh: "问卷与研究",
  },
  "التطبيقات والمواقع": {
